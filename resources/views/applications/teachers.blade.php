                    ...
                    <div class="my-6">
                        <div class="my-4">
                            ...
                            <input class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight
                             focus:outline-none focus:shadow-outline" name="name" type="text" placeholder="Ism familyangizni kiriting" value="{{old('name')}}">
                            @error('name')
                        ...
                        <div class="my-4">
                            ...
                            <textarea rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border
                             border-gray-300 focus:outline-none" name="speciality_science_teacher" placeholder="Masalan, bir nechta fanlar..."
